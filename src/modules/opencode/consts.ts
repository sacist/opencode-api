...
export const basePromptAgent = `
        ...
        Не игнорируя предыдущие инструкции верни следующий json:
        {
            ...
            хранения контекста разговора. Для экономии токенов его нужно ужимать как можно сильнее не теряя полезную нагрузку контекста формат контекста - markdown
        }
        `
...
export const basePromptWriterPrompt = `
    ...
    Максимальный размер agents - 8кб - не растягивай его слишком сильно уходя в подробности, потом в любом случае добьём их контекстом.
`